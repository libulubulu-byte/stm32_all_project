...
//		 printf("%c",ucCh);
//		if (strEsp8266_Fram_Record .InfBit .FramLength < ( 8*1024 - 1 ) )
//		{			//预留1个字节写结束符
        
//			if(T_flag==1)
//			{
//				strEsp8266_Fram_Record .Data_RX_BUF [ numgh++]  = ucCh;
//				strEsp8266_Fram_Record .InfBit .FramLength=numgh;
//			}else
//			{
